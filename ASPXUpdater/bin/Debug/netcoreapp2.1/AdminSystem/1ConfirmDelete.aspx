...
<body style="height: 100%;width: 100%;">
    <div class="container d-flex d-xl-flex justify-content-xl-center align-items-xl-center" style="height: 100%;width: 100%;background: #ff00d6;"><asp:Button ID="" runat="server" Text=""></asp:Button></div>
