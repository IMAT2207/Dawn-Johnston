...
<body>
    <div class="body" style="padding-top: 150px;">
        <div class="border rounded shadow d-flex d-sm-flex d-md-flex justify-content-center justify-content-sm-center justify-content-md-center login-center" style="filter: hue-rotate(0deg);padding-top: 30px;">
